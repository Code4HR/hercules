function initAutocomplete() {
    ...
    var map, heatmap, foodSanitationMarker;
    var heatMapData = [];
    var Datas = [];
        ...
        $.ajax({
            ...
            success: function(crimeData) {
                for (var elem = 0, max = crimeData.length; elem < max; elem++) {
                    newHeatMapData.push({location: new google.maps.LatLng(crimeData[elem].latitude, crimeData[elem].longitude), weight: crimeData[elem].severity});
                }
